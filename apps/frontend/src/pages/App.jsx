...
return (
  <Routes>
    ...
    {!authState ? (
      <>
        <Route path="/login" element={<LoginPage onLogin={(data) => setAuthState(data)} />} />
          ...
          <div className="card">
            ...
            <div className="body">
              ...
              {!loading && aba === 'fornecedores' && (
                <FornecedoresPage fornecedoresList={fornecedoresList} setFornecedoresList={setFornecedoresList} restauranteId={RESTAURANTE_ID} toast={toast} confirmar={confirmar} />
              )}
              {!loading && aba === 'itens' && (
                <ItensPage itensList={itensList} setItensList={setItensList} departamentosList={departamentosList} restauranteId={RESTAURANTE_ID} toast={toast} confirmar={confirmar} />
              )}
              {!loading && aba === 'enviar' && (
                <EnviarPage fornecedoresList={fornecedoresList} itensList={itensList} restauranteId={RESTAURANTE_ID} toast={toast} ultimaCotacaoId={ultimaCotacaoId} setUltimaCotacaoId={setUltimaCotacaoId} />
              )}
            </div>
          </div>
        </div>
